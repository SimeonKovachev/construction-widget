      ...
      <tr>
        <td colSpan={5} className="px-3 py-2">
          <Button
            ...
            className="!text-blue-600 hover:!text-blue-700 hover:!bg-blue-50 !px-2 !py-1 !gap-1.5"
          >
                ...
                <div key={category}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Button
                      ...
                      className="!text-red-400 hover:!text-red-600 hover:!bg-red-50 !px-2 !py-1 !gap-1"
                    >
